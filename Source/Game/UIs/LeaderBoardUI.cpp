...
LeaderBoardUI::LeaderBoardUI() {
    ...
    leaderBoardSprite->texture = LoadResourceManager::getInstance()->LoadTexture("../Data/Images/Icon_ColorIcon_Leaderboard.png");
    ...
    for(int i = 0 ; i < 5 ; i ++) {
        ...
        userName->getComponent<Text>()->font = LoadResourceManager::getInstance()->LoadFont("../Data/Text/BrownieStencil-8O8MJ.ttf", 20);
        ...
        userNameTransform->localPosition = {-200, 200 - i * 100.0f};
        ...
        score->getComponent<Text>()->font = LoadResourceManager::getInstance()->LoadFont("../Data/Text/BrownieStencil-8O8MJ.ttf", 20);
        ...
        scoreTransform->localPosition = {50, 200 - i * 100.0f};
