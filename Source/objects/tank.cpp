...
Tankk::Tankk(double x, double y, SpriteType type)
    : Object(x, y, type)
{
    direction = D_UP;
    m_slip_time = 0;
...
SDL_Rect Tankk::nextCollisionRect(Uint32 dt)
{
...
void Tankk::setDirection(Direction d)
{
...
void Tankk::collide(SDL_Rect &intersect_rect)
{
...
void Tankk::setFlag(TankStateFlag flag)
{
...
void Tankk::clearFlag(TankStateFlag flag)
{
    if(flag == TSF_SHIELD)
    {
...
bool Tankk::testFlag(TankStateFlag flag)
{
