...
string AppConfig::texture_path = "../resources/png/texture.png";
string AppConfig::levels_path = "../resources/levels/";
string AppConfig::font_name = "../resources/font/prstartk.ttf";
...
SDL_Rect AppConfig::room_rect = {0, 0, 52*32, 52*32};
SDL_Rect AppConfig::status_room_rect = {52*16, 0, 6*52, AppConfig::room_rect.h};
